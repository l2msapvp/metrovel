...
include('../modules/config_sql2.php');
...
$limite = 30; //Limite de usuarios na lista
...
<center><span class="style1">RANK</span> <?php echo strtoupper($array[$ordem]); ?>

<table width ="90%" border="0" cellspacing="2" cellpadding="0" align="center" class="error">

  <tr> 

    <td bgcolor="#333333" align="center"><strong>
